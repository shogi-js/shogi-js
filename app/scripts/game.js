...
var TestBed = {
  start: function () {
    ...
    Crafty.scene("loading", function() {
        // Load our assets
        Crafty.load([ "sounds/opening2.mp3", "sounds/snap.mp3",
                "sounds/ncoin.mp3",
                //"sounds/opening2.ogg",
                //"sounds/snap.ogg",
                //"sounds/ncoin.ogg",
    ...
    Crafty.scene("main", function() {
        ...
        Crafty.sprite("images/board.jpg", {SpriteBoard: [0, 0, 600, 640]});
        Crafty.sprite("images/mokume.png", {SpriteKomadai: [0, 0, 160, 380]});
        Crafty.sprite("images/koma.png", {SpritePiece:[0,0,60,64]});
